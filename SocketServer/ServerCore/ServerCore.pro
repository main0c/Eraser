# ServerCore Project - Pure backend service without UI
...
CONFIG(debug, debug|release) {
    DESTDIR = ../bin_servercore_debug
} else {
    DESTDIR = ../bin_servercore
}

DEFINES += ZMQ_SERVER CORE_SERVER
...
SOURCES += \
    $${PWD}/main.cpp \
    $${PWD}/ServerCoreApplication.cpp \
    $${PWD}/ClientToServerBridge.cpp \
    $${PWD}/DashboardToServerBridge.cpp

HEADERS += \
    $${PWD}/ServerCoreApplication.h \
    $${PWD}/ClientToServerBridge.h \
    $${PWD}/DashboardToServerBridge.h
